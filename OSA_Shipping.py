...
# Authentication
CLIENT_ID = st.sidebar.text_input("Client ID", "CLIENT_ID") # enter client ID
CLIENT_SECRET = st.sidebar.text_input("Client Secret", "CLIENT_SECRET!", type="password") #enter client secret
